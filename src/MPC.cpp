...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // For example : N = 20, 6 elements vector, input 2 elements
  // 6 * 20 + 2 * 19 = 158
  ...
  // The upper and lower limits of delta [-25, 25](degree)
  for (int i = delta_start; i < a_start; i++) {
    vars_lowerbound[i] = -0.436332; // [rad]
    vars_upperbound[i] = 0.436332; // [rad]
  }
